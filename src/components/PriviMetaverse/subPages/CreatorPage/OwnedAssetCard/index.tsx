...
export default function OwnedAssetCard(props) {
    ...
    <Box className={classes.card}>
      ...
      <Box 
        ...
        style={{
          ...
          backgroundImage: `url(${require("assets/gameImages/asset_sample.png")})`
        }}
      >
      </Box>
      <Box display="flex" justifyContent="space-between" style={{padding: "15px 14px 20px"}}>
        ...
        <Box display="flex" flexDirection="row">
          <Box className={classes.typo3} mr={1}>Price:</Box>
      ...
      <Box className={classes.footer}>
        <LocationIcon />
        <Box className={classes.typo3} ml={1}>Location:</Box>
        <Box className={classes.typo4} ml={1}>245,245</Box>
      </Box>
    </Box>
  );
}
